...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		if (txtName.getText() == null || txtName.getText().trim().equals("")) {
			exception.addError("name", "'Nome' não pode ficar vazio");
		}
		obj.setName(txtName.getText());

		if (txtEmail.getText() == null || txtEmail.getText().trim().equals("")) {
			exception.addError("email", "'Email' não pode ficar vazio");
		}
		obj.setEmail(txtEmail.getText());
		if (dpBirthDate.getValue() == null) {
			exception.addError("birthDate", "'Data de nascimento' não pode ficar vazia");
		} else {
		...
		if (txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("")) {
			exception.addError("baseSalary", "'Salário base' não pode ficar vazio");
		}
